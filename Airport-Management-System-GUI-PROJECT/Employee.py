...
db = sqlite3.connect("C:\\Users\\Yessi\\PycharmProjects\\pythonProject19\\DBFinal.db") #Connecting The DB to the python
    ...
    def LOGIN():
        ...
        def InputText():
            ...
            try:
                ...
                RealPass = cr.fetchall()[0][0] #Fetches from the password
